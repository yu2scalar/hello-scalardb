...
public class UpdateRecord {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
    		...
    		System.out.println(NAME_SPACE_POSTGRES + ": id:" + String.valueOf(resultP.get().getInt("id"))+ "/comment:" + comment);
    		System.out.println(NAME_SPACE_MYSQL + ": id:" + String.valueOf(resultM.get().getInt("id"))+ "/comment:" + comment);
